...
const ozelMesaj = isGroup => Degisken(`
    *Merhaba,Ben Yaş Tahmin Oyunu Zamanınızı eğlenceli hale getirimek için\nTelegram oyun botuyum🤖*
    ...
    await ctx.replyWithMarkdown(ozelMesaj(ctx.update.message.chat.id < 0),{
        reply_markup:{
            inline_keyboard:[
                ...
                [{text:'Resmi Kanalımız 📣', url:`t.me/CreativBlog`},{text:'VİP Gruplar 💎', callback_data:'vip'}]
            ]
        }
    })
})
...
bot.action('start', ctx=>{
    ctx.deleteMessage()
    ctx.replyWithMarkdown(`*Merhaba,Ben Yaş Tahmin Oyunu Zamanınızı eğlenceli hale getirimek için\nTelegram oyun botuyum🤖\n**Temel komutların listesi için /yardim*
        `,{
        reply_markup:{
            inline_keyboard:[
...
bot.action('AZ', ctx=>{
    ...
    ctx.replyWithMarkdown(`*🇦🇿 VİP Gruplar 🏆*`,{
        reply_markup:{
            inline_keyboard:[
                [{text:'1) Qrup ', url:'t.me/sumqayitchattt'}],
                [{text:'2) Qrup ', url:'t.me/vorovskayamusic'}],
...
*🇹🇷 VİP Gruplar 🏆*
        ...
        reply_markup:{
            inline_keyboard:[
                [{text:'1) Grub', url:'t.me/Sohbeti_muhabbet'}],
                [{text:'2) Grub', url:'t.me/sohbetgotr'}],
                [{text:'🔙 Geri', callback_data:'vip'}]
            ]
        }
    })
